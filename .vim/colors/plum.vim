...
let s:light_grey1          = ['808080', 241]
let s:light_grey2          = ["b3b3b3", 245]
let s:light_grey3          = ["a6a6a6", 247]
let s:light_grey4          = ["efefef", 250]
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>H( "Search", [s:dark_cyan, s:light_bg],  [s:dark_red, s:light_fg], "")  " Last search pattern highlighting (see 'hlsearch'). Also used for highlighting the current line in the quickfix window and similar items that need to stand out.
    call <SID>H( "IncSearch", [s:dark_red, s:light_fg], [s:dark_fg, s:light_bg], "")  " 'incsearch' highlighting; also used for the text replaced with ':s///c'
    ...
    call <SID>H( "Linenr", [s:dark_lighterbg2, s:light_grey1], [], "" )  " line number for ':number' and ':#' commands, and when 'number' or 'relativenumber' option is set.
    ...
    call <SID>H( "Constant", [s:dark_grey, s:light_green], [], "" )  " any constant
    ...
    call <SID>H( "Boolean", [s:dark_grey, s:light_green], [], "" )  " a boolean constant: TRUE, false
    ...
    call <SID>H( "Conditional",[s:dark_pink, s:light_blue], [], "" )  " if, then, else, endif, switch, etc
    ...
    call <SID>H( "Special", [s:dark_darkerfg, s:light_cyan], [], "")  " any special symbol
    ...
    call <SID>H( "javaScriptMember", [s:dark_darkerfg, s:light_purple], [], "" )
    call <SID>H( "javaScriptGlobal", [s:dark_darkerfg, s:light_orange], [], "" )
    call <SID>H( "javaScriptReserver", [s:dark_blue, s:light_blue], [], "" )
    call <SID>H( "javaScriptNull", [s:dark_grey, s:light_cyan], [], "" )
    call <SID>H( "javaScriptType", [s:dark_fg, s:light_cyan], [], "" )
    call <SID>H( "javaScriptNumber", [s:dark_grey, s:light_cyan], [], "" )
